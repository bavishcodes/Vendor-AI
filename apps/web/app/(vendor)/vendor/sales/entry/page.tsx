...
import { Package, IndianRupee, Save, Plus, Trash2, Calendar, AlertCircle, TrendingUp } from "lucide-react";
...
export default function DailySalesEntryPage() {
    const { items, updateItemStock, updateItemQuantity } = useInventory();
