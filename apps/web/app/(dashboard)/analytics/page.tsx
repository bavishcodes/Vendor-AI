        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-light-green/30">
                    ...
                    <h3 className="text-2xl font-bold text-charcoal h-8">₹ 12.8L</h3>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-light-green/30">
                    ...
                    <h3 className="text-2xl font-bold text-charcoal h-8">₹ 420</h3>
                    <div className="flex items-center text-deep-green text-xs font-bold mt-2">
                        <TrendingUp className="w-3 h-3 mr-1" />
                        +2.1% vs last period
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-light-green/30">
                    ...
                    <h3 className="text-2xl font-bold text-charcoal h-8">124</h3>
